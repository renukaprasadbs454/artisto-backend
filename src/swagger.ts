            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  password: { type: 'string', example: 'Str0ng!Pass' , description: 'Minimum 8 characters with at least one uppercase, one lowercase, one number and one special character.'},
